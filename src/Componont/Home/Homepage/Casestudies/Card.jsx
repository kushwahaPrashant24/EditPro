    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="p-5 flex flex-col gap-5">
          <h1 className="text-3xl font-bold">Would you like to know more about the project?</h1>
          <p className="text-2xl mt-5">
            To find more about our work or any of our other brands, get in touch. Mail us on <span>{props.email}</span> or call <span>{props.phone}</span>.
          </p>
        </div>
      </div>
